...
window.onload = function() {
    console.log('Оценка: 26/110.\nВыполнено только бургер-меню, остальное не успел.\nВсе требования ТЗ касательно бургер-меню соблюдены.\nЕсли ты это читаешь, то удачного тебе дня!');
}
